...
function init() {
  ...
  const light = new THREE.PointLight( 0xffffff, 2.4, 0 );
  light.position.set( 10, 5, 10 );
  scene.add( light );

  const light2 = new THREE.PointLight( 0xffffff, 2.4, 0 );
  light2.position.set( -10, 5, 10 );
  scene.add( light2 );

  const light3 = new THREE.PointLight( 0xffffff, 2.4, 0 );
  light3.position.set( 10, 5, -10 );
  scene.add( light3 );

  const light4 = new THREE.PointLight( 0xffffff, 2.4, 0 );
