...
const geometry2_ttl = new THREE.PlaneBufferGeometry( 60, 20 );
...
stop2_ttl.position.set(0, 16, 501);
...
const geometry3_email = new THREE.PlaneBufferGeometry( 59, 8 );
...
function animate() {
    ...
    if (!unlock) {
      if(scale_factor < 1) {
        ...
        document.querySelector("#loader").style.opacity = 0;
        setTimeout(function(){
          document.querySelector("#mouse_icon").classList.add("active");
          document.querySelector("#loader").style.display = "none";
        }, 1000);
      }
    }
...
function options_active() {
  document.querySelector("#scene2_options").classList.add("active");
  document.querySelector("#close_bttn").classList.add("active");
}

function close_all() {
  document.querySelector("#scene2_options").classList.remove("active");
  document.querySelector("#close_bttn").classList.remove("active");

  document.querySelector("#space_music").classList.add("inactive");
  document.querySelector("#watch").classList.add("inactive");
  document.querySelector("#listen").classList.add("inactive");
  document.querySelector("#read").classList.add("inactive");
  document.querySelector("#subscribe").classList.add("inactive");
  document.querySelector("#become").classList.add("inactive");
  document.querySelector("#why").classList.add("inactive");
}
...
function animate2() {
    ...
    if(scene2_cam_pos > 100) {
      document.querySelector("#mouse_icon").classList.remove("active");
    } else {
      document.querySelector("#mouse_icon").classList.add("active");
    }
    ...
    if (raycaster2.intersectObject(stop1_1).length > 0) {
      ...
      document.querySelector("canvas").onclick = function() {
        document.querySelector("#space_music").classList.remove("inactive");
        document.querySelector("#close_bttn").addEventListener("click", close_all);
        options_active();
      }
      ...
      document.querySelector("canvas").onclick = function() {
        document.querySelector("#watch").classList.remove("inactive");
        document.querySelector("#close_bttn").addEventListener("click", close_all);
        options_active();
      }
      ...
      document.querySelector("canvas").onclick = function() {
        document.querySelector("#listen").classList.remove("inactive");
        document.querySelector("#close_bttn").addEventListener("click", close_all);
        options_active();
      }
      ...
      document.querySelector("canvas").onclick = function() {
        document.querySelector("#read").classList.remove("inactive");
        document.querySelector("#close_bttn").addEventListener("click", close_all);
        options_active();
      }
      ...
      document.querySelector("canvas").onclick = function() {
        document.querySelector("#subscribe").classList.remove("inactive");
        document.querySelector("#close_bttn").addEventListener("click", close_all);
        options_active();
      }
      ...
      document.querySelector("canvas").onclick = function() {
        document.querySelector("#become").classList.remove("inactive");
      ...
      document.querySelector("canvas").onclick = function() {
        window.location.href = "https://www.instagram.com/bitlennial/";
      }
      ...
      document.querySelector("canvas").onclick = function() {
        document.querySelector("#why").classList.remove("inactive");
        document.querySelector("#close_bttn").addEventListener("click", close_all);
        options_active();
      }
    } else {
