...
//   $("#cirlces_mobile").setAttribute("style", "display: block");
// }else{
//   $("#cirlces_desktop").setAttribute("style", "display: block");
// }
let tmt;
...
$("#click_center").onclick = function() {
  $("#drop_down").classList.add("active");
}
$("#click_bottom").onclick = function() {
  clearTimeout(tmt);
  $("#smoke").setAttribute("class", "click_point_03");
  $("#section_circles").setAttribute("class", "invis");
  tmt = setTimeout(function(){
