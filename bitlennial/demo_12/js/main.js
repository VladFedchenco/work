    ...
    if (!unlock) {
      if(scale_factor < 1) {
        ...
        setTimeout(function(){
          ...
          document.querySelector("#pointer_icon").classList.add("active");
          document.querySelector("#loader").style.display = "none";
        }, 1000);
      }
    }
...
document.querySelector("#skip").onclick = skip_intro;
...
function animate2() {
    ...
    if(scene2_cam_pos > 600) {
      ...
      document.querySelector("#pointer_icon").classList.remove("active");
    } else {
      document.querySelector("#mouse_icon").classList.add("active");
      document.querySelector("#pointer_icon").classList.add("active");
    }
